!function (e) {
  ...
  n.m = e, n.c = t, n.d = function (e, t, r) {
    ...
    if (n.r(r), Object.defineProperty(r, "default", {enumerable: true, value: e}), 2 & t && "string" != typeof e) for (var i in e) n.d(r, i, function (t) {
      return e[t];
    }.bind(null, i));
    return r;
  }, n.n = function (e) {
  ...
  (function (t, n) {
    !function () {
      ...
      function r(e, t, n, r, i, o) {
        return {tag: e, key: t, attrs: n, children: r, text: i, dom: o, domSize: void 0, state: void 0, _state: void 0, events: void 0, instance: void 0, skip: false};
      }
      r.normalize = function (e) {
        return Array.isArray(e) ? r("[", void 0, void 0, r.normalizeChildren(e), void 0, void 0) : null != e && "object" != typeof e ? r("#", void 0, void 0, false === e ? "" : e, void 0, void 0) : e;
      }, r.normalizeChildren = function (e) {
        for (var t = 0; t < e.length; t++) e[t] = r.normalize(e[t]);
        return e;
      };
      var i = /(?:(^|#|\.)([^#\.\[\]]+))|(\[(.+?)(?:\s*=\s*("|'|)((?:\\["'\]]|.)*?)\5)?\])/g, o = {}, a = {}.hasOwnProperty;
      function u(e) {
        for (var t in e) if (a.call(e, t)) return false;
        return true;
      }
      function l(e) {
        var t, n = arguments[1], l = 2;
        ...
        if ("string" == typeof e) var c = o[e] || function (e) {
          for (var t, n = "div", r = [], a = {}; t = i.exec(e);) {
            var u = t[1], l = t[2];
            if ("" === u && "" !== l) n = l; else if ("#" === u) a.id = l; else if ("." === u) r.push(l); else if ("[" === t[3][0]) {
              var c = t[6];
              c && (c = c.replace(/\\(["'])/g, "$1").replace(/\\\\/g, "\\")), "class" === t[4] ? r.push(c) : a[t[4]] = "" === c ? c : c || true;
            }
          }
          return r.length > 0 && (a.className = r.join(" ")), o[e] = {tag: n, attrs: a};
        }(e);
        if (null == n ? n = {} : ("object" != typeof n || null != n.tag || Array.isArray(n)) && (n = {}, l = 1), arguments.length === l + 1) t = arguments[l], Array.isArray(t) || (t = [t]); else for (t = []; l < arguments.length;) t.push(arguments[l++]);
        var s = r.normalizeChildren(t);
        return "string" == typeof e ? function (e, t, n) {
          var i, o, l = false, c = t.className || t.class;
          if (!u(e.attrs) && !u(t)) {
            var s = {};
          ...
          for (var f in void 0 !== c && (void 0 !== t.class && (t.class = void 0, t.className = c), null != e.attrs.className && (t.className = e.attrs.className + " " + c)), t) if (a.call(t, f) && "key" !== f) {
            l = true;
            break;
          }
      ...
      if ((s = function (e) {
        ...
        var n = this, r = [], i = [], o = c(r, true), a = c(i, false), u = n._instance = {resolvers: r, rejectors: i}, l = "function" == typeof t ? t : setTimeout;
        function c(e, t) {
          return function o(c) {
            var s;
            try {
        ...
        function o(e, t, o, a) {
          t.push(function (t) {
            if ("function" != typeof e) o(t); else try {
              n(e(t));
            } catch (e) {
              r && r(e);
            }
        ...
        return o(e, i.resolvers, n, true), o(t, i.rejectors, r, false), a;
        ...
        return new s(function (t, n) {
          var r = e.length, i = 0, o = [];
          if (0 === e.length) t([]); else for (var a = 0; a < e.length; a++) !function (a) {
            function u(e) {
              i++, o[a] = e, i === r && t(o);
            }
      ...
      var f = function (e) {
        ...
        return t.join("&");
        function r(e, n) {
          if (Array.isArray(n)) for (var i = 0; i < n.length; i++) r(e + "[" + i + "]", n[i]); else if ("[object Object]" === Object.prototype.toString.call(n)) for (var i in n) r(e + "[" + i + "]", n[i]); else t.push(encodeURIComponent(e) + (null != n && "" !== n ? "=" + encodeURIComponent(n) : ""));
        }
      }, d = new RegExp("^file://", "i"), g = function (e, t) {
        var n, r = 0;
        function i() {
          var e = 0;
          function t() {
        ...
        return {request: function (n, r) {
          ...
          var g = new t(function (t, r) {
            ...
            var o = new e.XMLHttpRequest, f = false, g = o.abort;
            ...
            "function" == typeof n.config && (o = n.config(o, n) || o), o.onreadystatechange = function () {
              if (!f && 4 === o.readyState) try {
                ...
                if (o.status >= 200 && o.status < 300 || 304 === o.status || d.test(n.url)) t(s(n.type, e)); else {
          ...
          return true === n.background ? g : f(g);
        }, jsonp: function (n, l) {
          var c = i();
          n = o(n, l);
          var f = new t(function (t, i) {
            var o = n.callbackName || "_mithril_" + Math.round(1e16 * Math.random()) + "_" + r++, l = e.document.createElement("script");
            e[o] = function (r) {
          ...
          return true === n.background ? f : c(f);
        }, setCompletionCallback: function (e) {
          n = e;
        }};
      }(window, s), m = function (e) {
        var t, n = e.document, i = n.createDocumentFragment(), o = {svg: "http://www.w3.org/2000/svg", math: "http://www.w3.org/1998/Math/MathML"};
        function a(e) {
          ...
          switch (t.state = {}, null != t.attrs && b(t.attrs, t, o), g) {
            ...
            default:
              return function (e, t, i, o, l) {
                var c = t.tag, s = t.attrs, f = s && s.is, d = (o = a(t) || o) ? f ? n.createElementNS(o, c, {is: f}) : n.createElementNS(o, c) : f ? n.createElement(c, {is: f}) : n.createElement(c);
                t.dom = d, null != s && function (e, t, n) {
                  for (var r in t) x(e, r, null, t[r], n);
                }(t, s, o);
                if (p(e, d, l), null != t.attrs && null != t.attrs.contenteditable) h(t); else if (null != t.text && ("" !== t.text ? d.textContent = t.text : t.children = [r("#", void 0, void 0, t.text, void 0, void 0)]), null != t.children) {
                  var g = t.children;
                  u(d, g, 0, g.length, i, null, o), function (e) {
                    var t = e.attrs;
        ...
        function c(e, t, r) {
          var i = {caption: "table", thead: "table", tbody: "table", tfoot: "table", tr: "tbody", th: "tr", td: "tr", colgroup: "table", col: "colgroup"}[(t.children.match(/^\s*?<(\w+)/im) || [])[1]] || "div", o = n.createElement(i);
        ...
        function s(e, t) {
          ...
          if ("function" == typeof e.tag.view) {
            ...
            n.$$reentrantLock$$ = true, e.state = null != e.tag.prototype && "function" == typeof e.tag.prototype.view ? new e.tag(e) : e.tag(e);
          }
        ...
        function f(e, t, n, r, i, o, a) {
          if (t !== n && (null != t || null != n)) if (null == t) u(e, n, 0, n.length, i, o, a); else if (null == n) v(t, 0, t.length, n); else {
            if (t.length === n.length) {
              for (var c = false, s = 0; s < n.length; s++) if (null != n[s] && null != t[s]) {
            ...
            if (r = r || function (e, t) {
              if (null != e.pool && Math.abs(e.pool.length - t.length) <= Math.abs(e.length - t.length)) {
                var n = e[0] && e[0].children && e[0].children.length || 0, r = e.pool[0] && e.pool[0].children && e.pool[0].children.length || 0, i = t[0] && t[0].children && t[0].children.length || 0;
                if (Math.abs(r - i) <= Math.abs(n - i)) return true;
              }
              return false;
            }(t, n)) {
              var f = t.pool;
            ...
            for (var h, w = 0, y = 0, x = t.length - 1, N = n.length - 1; x >= w && N >= y;) {
              if ((b = t[w]) !== (I = n[y]) || r) if (null == b) w++; else if (null == I) y++; else if (b.key === I.key) {
                var D = null != f && w >= t.length - f.length || null == f && r;
                y++, d(e, b, I, i, M(t, ++w, o), D, a), r && b.tag === I.tag && p(e, m(b), o);
              } else {
                if ((b = t[x]) !== I || r) if (null == b) x--; else if (null == I) y++; else {
            ...
            for (; x >= w && N >= y;) {
              var b, I;
              if ((b = t[x]) !== (I = n[N]) || r) if (null == b) x--; else if (null == I) N--; else if (b.key === I.key) {
                D = null != f && x >= t.length - f.length || null == f && r;
                ...
                if (h || (h = g(t, x)), null != I) {
                  ...
                  if (null != T) {
                    ...
                    d(e, j, I, i, M(t, x + 1, o), r, a), p(e, m(j), o), t[T].skip = true, null != j.dom && (o = j.dom);
                  } else {
                    o = l(e, I, i, a, o);
                  }
                }
        ...
        function d(e, t, n, i, o, u, g) {
          ...
          if (M === n.tag) {
            if (n.state = t.state, n._state = t._state, n.events = t.events, !u && function (e, t) {
              ...
              if (!(void 0 === n && void 0 === r || n || r)) return e.dom = t.dom, e.domSize = t.domSize, e.instance = t.instance, true;
              return false;
            }(n, t)) return;
            if ("string" == typeof M) switch (null != n.attrs && (u ? (n.state = {}, b(n.attrs, n, i)) : I(n.attrs, n, i)), M) {
              ...
              default:
                !function (e, t, n, i, o) {
                  ...
                  (function (e, t, n, r) {
                    if (null != n) for (var i in n) x(e, i, t && t[i], n[i], r);
                    if (null != t) for (var i in t) null != n && i in n || ("className" === i && (i = "class"), "o" !== i[0] || "n" !== i[1] || N(i) ? "key" !== i && e.dom.removeAttribute(i) : D(e, i, void 0));
        ...
        function v(e, t, n, r) {
          for (var i = t; i < n; i++) {
            var o = e[i];
            null != o && (o.skip ? o.skip = false : w(o, r));
          }
        }
        function w(e, t) {
          var n, r = 1, i = 0;
          ...
          function o() {
            if (++i === r && (function e(t) {
              ...
              var n = e.domSize || 1;
              if (n > 1) for (var o = e.dom; --n;) y(o.nextSibling);
        ...
        function x(e, t, r, i, o) {
          ...
          if ("key" !== t && "is" !== t && (r !== i || function (e, t) {
            ...
            var u = t.indexOf(":");
            if (u > -1 && "xlink" === t.substr(0, u)) a.setAttributeNS("http://www.w3.org/1999/xlink", t.slice(u + 1), i); else if ("o" === t[0] && "n" === t[1] && "function" == typeof i) D(e, t, i); else if ("style" === t) !function (e, t, n) {
            ...
            }(a, r, i); else if (t in a && !function (e) {
        ...
        function D(e, n, r) {
          var i = e.dom, o = "function" != typeof t ? r : function (e) {
            var n = r.call(i, e);
            return t.call(i, e), n;
          };
          if (n in i) i[n] = "function" == typeof r ? o : null; else {
            var a = n.slice(2);
            if (void 0 === e.events && (e.events = {}), e.events[n] === o) return;
            null != e.events[n] && i.removeEventListener(a, e.events[n], false), "function" == typeof r && (e.events[n] = o, i.addEventListener(a, e.events[n], false));
          }
        }
        function b(e, t, n) {
        ...
        return {render: function (e, t) {
          ...
          var i = [], o = n.activeElement, a = e.namespaceURI;
          null == e.vnodes && (e.textContent = ""), Array.isArray(t) || (t = [t]), f(e, e.vnodes, r.normalizeChildren(t), false, i, null, "http://www.w3.org/1999/xhtml" === a ? void 0 : a), e.vnodes = t, null != o && n.activeElement !== o && o.focus();
      ...
      var M = function (e) {
        ...
        t.setEventCallback(function (e) {
          false === e.redraw ? e.redraw = void 0 : i();
        });
        var n = [];
        function r(e) {
          var t = n.indexOf(e);
        ...
        return {subscribe: function (e, t) {
          r(e), n.push(e, function (e) {
            var t = 0, n = null, r = "function" == typeof requestAnimationFrame ? requestAnimationFrame : setTimeout;
            return function () {
              var i = Date.now();
        ...
        }, unsubscribe: r, redraw: i, render: t.render};
      }(window);
      ...
      var p = s, h = function (e) {
        if ("" === e || null == e) return {};
        "?" === e.charAt(0) && (e = e.slice(1));
        for (var t = e.split("&"), n = {}, r = {}, i = 0; i < t.length; i++) {
          var o = t[i].split("="), a = decodeURIComponent(o[0]), u = 2 === o.length ? decodeURIComponent(o[1]) : "";
          "true" === u ? u = true : "false" === u && (u = false);
          var l = a.split(/\]\[?|\[/), c = n;
          a.indexOf("[") > -1 && l.pop();
          for (var s = 0; s < l.length; s++) {
            var f = l[s], d = l[s + 1], g = "" == d || !isNaN(parseInt(d, 10)), m = s === l.length - 1;
        ...
        var n, r = "function" == typeof e.history.pushState, i = "function" == typeof t ? t : setTimeout;
        function o(t) {
          var n = e.location[t].replace(/(?:%[a-f89][a-f0-9])+/gim, decodeURIComponent);
          return "pathname" === t && "/" !== n[0] && (n = "/" + n), n;
        }
        function a(e, t, n) {
          var r = e.indexOf("?"), i = e.indexOf("#"), o = r > -1 ? r : i > -1 ? i : e.length;
          if (r > -1) {
            var a = i > -1 ? i : e.length, u = h(e.slice(r + 1, a));
        ...
        var u = {prefix: "#!", getPath: function () {
          ...
          var d = f(l);
          if (d && (t += "#" + d), r) {
            var g = i ? i.state : null, m = i ? i.title : null;
        ...
        return u.defineRoutes = function (t, o, l) {
          function c() {
            var n = u.getPath(), r = {}, i = a(n, r, r), c = e.history.state;
            if (null != c) for (var s in c) r[s] = c[s];
            for (var f in t) {
      ...
      c.route = function (e, t) {
        var n, i, o, a, u, l = v(e), c = function (e, c, s) {
        ...
        return c.set = function (e, t, n) {
          null != u && ((n = n || {}).replace = true), u = null, l.setPath(e, t, n);
        }, c.get = function () {
          return a;
        }, c.prefix = function (e) {
          l.prefix = e;
          ...
          e.dom.setAttribute("href", l.prefix + e.attrs.href), e.dom.onclick = function (e) {
            if (!(e.ctrlKey || e.metaKey || e.shiftKey || 2 === e.which)) {
              e.preventDefault(), e.redraw = false;
  ...
  var r = {};
  t.default = {update: function (e) {
    r = Object.assign({}, {ratio: "landscape"}, e);
  }, data: function () {
    return r;
  }};
}, function (e, t, n) {
  ...
  (function (e) {
    ...
    window.MediumWidget = {Init: function (n) {
  ...
  (function (e, t) {
    !function (e, n) {
      "use strict";
      if (!e.setImmediate) {
        var r, i = 1, o = {}, a = false, u = e.document, l = Object.getPrototypeOf && Object.getPrototypeOf(e);
        l = l && l.setTimeout ? l : e, "[object process]" === {}.toString.call(e.process) ? r = function (e) {
          ...
          e.addEventListener ? e.addEventListener("message", n, false) : e.attachEvent("onmessage", n), r = function (n) {
            e.postMessage(t + n, "*");
          };
  ...
  var l, c = [], s = false, f = -1;
  function d() {
    s && l && (s = false, l.length ? c = l.concat(c) : f = -1, c.length && g());
  }
  function g() {
    if (!s) {
      var e = u(d);
  ...
  "use strict";
  (function (e) {
    Object.defineProperty(t, "__esModule", {value: true}), n(8);
    var r = function (e) {
      return e && e.__esModule ? e : {default: e};
    }(n(13));
    t.default = function () {
  ...
  function f(e, t) {
    for (var n = [], r = {}, i = 0; i < e.length; i++) {
      var o = e[i], a = t.base ? o[0] + t.base : o[0], u = {css: o[1], media: o[2], sourceMap: o[3]};
  ...
  function p(e, t) {
    ...
    if (t.singleton) {
      var l = u++;
      n = a || (a = m(t)), r = v.bind(null, n, l, false), i = v.bind(null, n, l, true);
  ...
  (function (e) {
    Object.defineProperty(t, "__esModule", {value: true});
    var r = a(n(14)), i = a(n(2)), o = n(18);
    function a(e) {
      return e && e.__esModule ? e : {default: e};
    }
    t.default = function () {
      return {data: {config: i.default.data(), articles: []}, postsPerLine: function () {
        return parseInt(this.data.config.postsPerLine) || 1;
      }, requestQuery: function () {
        var e = this.data.config, t = e.fields || [];
        return -1 !== t.indexOf("author") && t.push("avatar"), {fields: t, resource: e.resource, limit: e.limit, picture: e.picture};
      }, loadArticles: function () {
        var t = this;
        this.isLoading = true;
        var n = new Event("medium-widget:loading"), r = new Event("medium-widget:loaded"), i = new Event("medium-widget:failed");
        document.dispatchEvent(n), e.request({method: "GET", url: "https://medium-widget-api.pixelpoint.io/api/v1/articles", extract: function (e) {
          return {xhr: e};
        }, data: this.requestQuery()}).then(function (e) {
          try {
            t.data.articles = JSON.parse(e.xhr.responseText);
          } catch (e) {
            console.error("Invalid server response.");
          }
          false === Array.isArray(t.data.articles) && (console.error("Invalid server response."), t.data.articles = []), 0 === t.data.articles.length && console.error("There is no data available for this resource."), t.isLoading = false, document.dispatchEvent(r);
        }, function (e) {
          e.xhr.status >= 400 ? console.error("Error #" + e.xhr.status + " " + e.xhr.statusText) : console.error(e.message), t.isLoading = false, document.dispatchEvent(i);
        });
      }, oninit: function () {
        this.isLoading = false, this.loadArticles();
      }, view: function () {
        var t = this.data.config, n = this.data.articles.slice();
        return (0, o.chunk)(n, this.postsPerLine()).map(function (n) {
          return e(".medium-widget-article__row", n.map(function (n) {
            return e(r.default, {article: n, config: t});
          }));
        });
      }};
    };
  ...
  (function (e) {
    Object.defineProperty(t, "__esModule", {value: true});
    var r = n(15), i = n(16), o = function (e) {
      return e && e.__esModule ? e : {default: e};
    }(n(17));
    t.default = function () {
      return {date: function (e) {
        ...
        var n = t.attrs, r = n.article, i = n.config;
        this.config = i;
  ...
  "use strict";
  Object.defineProperty(t, "__esModule", {value: true}), t.fancyDate = function (e) {
    var t = new Date(e);
    return ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"][t.getMonth()] + " " + t.getDate() + ", " + t.getFullYear();
  };
}, function (e, t, n) {
  "use strict";
  Object.defineProperty(t, "__esModule", {value: true}), t.fancyNumber = function (e) {
    var t = "" + e;
    if (t.length > 3) {
      var n = t.slice(0, -3), r = t.split("").slice(-3)[0];
  ...
  (function (e) {
    Object.defineProperty(t, "__esModule", {value: true}), t.default = function () {
      return {data: {rendered: false}, oninit: function (e) {
        ...
        if (this.pictureId && "none" !== this.picture && this.data.rendered) return e("a.medium-widget-article__image", {href: t.attrs.url, target: "_blank"}, e("img", {src: this.getPictureUrl()}));
      }};
    };
  }.call(this, n(0)));
}, function (e, t, n) {
  "use strict";
  Object.defineProperty(t, "__esModule", {value: true}), t.chunk = function (e, t) {
    var n, r = [], i = 0;
